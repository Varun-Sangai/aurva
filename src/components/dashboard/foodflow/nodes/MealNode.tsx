  ...
  return (
    <>
      <Handle
        ...
        className="opacity-0"
      />
      <div className="p-3 border-grey-300 shadow-lg  bg-white border-solid border-[0.125rem] min-w-28 max-w-80 flex gap-2 items-center rounded-md hover:!shadow-cyan-200 hover:bg-cyan-200 hover:!border-none  transition-all ease-in-out duration-500">
        <div className="p-1.5 rounded-md bg-cyan-600">
          <img src={mealSvg} className="w-4 h-4"></img>
