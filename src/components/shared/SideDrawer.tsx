...
export default function SideDrawer({
  ...
  return (
    <div {...overlayProps}
      ...
      <div {...sidedrawerProps} className={twMerge(`fixed top-0 right-0 w-full overflow-y-auto max-w-lg h-full flex flex-col  bg-white transition-all z-10 ${open ? "translate-x-0" : "translate-x-full"}`, sidedrawerProps?.className)}>
